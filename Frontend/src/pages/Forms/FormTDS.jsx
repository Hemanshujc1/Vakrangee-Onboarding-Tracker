...
const FormTDS = () => {
  ...
  const validationSchema = useMemo(() => Yup.object({
     ...
     pan_no: commonSchemas.panNo,
     contact_no: commonSchemas.mobileNumber,
     employee_name: commonSchemas.nameString,
     job_title: Yup.string().required("Required"),
     
     // Numerical fields
     education_loan_amt: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     education_interest: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     housing_loan_principal: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     housing_loan_interest: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     nps_contribution: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     hra_rent_per_month: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     hra_months: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(1, "Enter a Valid month").max(12, "Enter the valid month"), // Months usually 1-12 or 1-24
     medical_total_contribution: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     medical_self_family: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     medical_parents: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     medical_senior_parents: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     life_insurance_premium: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     ssy_contribution: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     ppf_contribution: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     nsc_subscription: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     united_link_subsciption: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     banks_bonds: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     fd_bank: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     children_tuition_fees: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     mf_investment: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
     other_investment_amt: Yup.number().transform((value) => (isNaN(value) ? null : value)).nullable().min(0, "Min 0").max(9999999999, "Max 10 digits"),
