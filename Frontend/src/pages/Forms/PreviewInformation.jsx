...
const PreviewInformation = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 print:p-0 print:m-0 print:w-full print:min-h-0 print:h-auto print:bg-white text-xs">
      <div className="max-w-[210mm] mx-auto print:max-w-[210mm] print:mx-auto print:w-full print:p-0">
        <div className="bg-white p-4 md:p-8 shadow-lg rounded-sm min-h-[297mm] flex flex-col print:w-full print:max-w-full print:min-h-0 print:m-0 print:p-8 print:shadow-none print:a4-print-container">
          {/* Actions Bar */}
            ...
            <div className="flex flex-col md:block print:block">
              ...
              {(data.profile_photo_path ||
                ...
                <img
                  ...
                  alt="Profile"
                  className="md:absolute print:absolute top-30 right-0 w-32 h-32 object-cover border border-black mx-auto mb-4 md:mb-0 print:mb-0"
                />
              )}
            </div>
          ...
          <div className="p-0.5 mb-6 text-sm">
            <div className="p-2">
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  After completing the form please ensure that you have attached
          ...
          <div className="overflow-x-auto [&::-webkit-scrollbar]:hidden print:overflow-visible w-full mb-6">
            <div className="min-w-150 print:min-w-0 grid grid-cols-[140px_1fr] gap-y-2 items-center">
            ...
            <div className="border border-gray-800 p-2 space-y-2">
              ...
              <div className="flex flex-col md:flex-row print:flex-row gap-4">
                ...
                <div className="flex items-center gap-2 flex-1">
                  ...
                  <PrintText
                    value={data.current_post_office}
                    className="flex-1"
                  />
                </div>
              </div>
      ...
      bg-gray-100 italic tracking-wider font-bold text-black border border-gray-800 p-1 text-center text-sm mb-2 mt-4"
            ...
            <div className="min-w-175 print:min-w-0">
              ...
              <div className="mb-8 relative break-inside-avoid">
                <h4 className="font-bold mb-4 uppercase text-sm">
                  SIGNIFICANT ACHIEVEMENTS / OTHER COURSES / DIPLOMA COMPLETED:
                  (Please mention Institute name / Year of completion /
                  Duration)
                </h4>
              ...
              {(data.employment_details || []).map((emp, index) => (
                ...
                >
                  ...
                  <div className="border-b border-gray-800 p-1 text-[9px] italic text-left">
                    In case the reporting period to the above Referee is less
                    than 9 months or any other Supervisor in the above stated
                    tenure, Kindly give details of the next reporting
                    Supervisor.
                  </div>
          ...
          <div className="mt-8 border-t-2 border-gray-800 pt-4">
            <p className="font-bold mb-4 text-justify">
              I have no objection, the Management of Vakrangee Ltd. to verify
              the information such as personal details, contact details,
              education details, criminal verification and previous employment
              details wherever applicable prior to my appointment. If the
              information given to you is not found correct as per my
              declaration, then the company can take disciplinary action against
              me.
            </p>
