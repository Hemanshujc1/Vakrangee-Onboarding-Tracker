        ...
        <div className="flex flex-col h-full print:p-8">
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <p className="italic text-xs">See sub-rule (1) of Rule 6</p>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-1 text-sm">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <p>
                      (b) My husband's father/mother/parents is/are not
                ...
                <div className="flex gap-2">
                  ...
                  <p>
                    ...
                    to the controlling authority in terms of the proviso to
                    clause (h) of Section 2 of the said Act.
                  </p>
                </div>
                <div className="flex gap-2">
              ...
              <div className="page-break-inside-avoid">
                ...
                <div className="flex flex-col w-full md:w-1/3 print:w-1/3 gap-4">
                  ...
                  <div className="flex items-end gap-2">
                    ...
                    <span className="flex-1 border-b border-black font-bold h-6 relative top-1">
                      {formatDate(
                        formData.witnesses_date ||
                          formData.witnesses?.[0]?.date,
                      )}
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-12 page-break-inside-avoid">
                ...
                <p className="mb-6">
                  Certified that the particulars of the above nomination have
                  been verified and recorded in this establishment.
                </p>
