...
import { UserPlus, Search, Filter, Eye, Trash2, MoreVertical } from 'lucide-react';
  ...
  return (
    <DashboardLayout>
      <header className="mb-8 flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-(--color-text-dark)">Manage Employees</h1>
          <p className="text-gray-500 mt-2">View and manage all employees in the system.</p>
        </div>
        <button 
                ...
                <table className="w-full text-left">
                  <thead className="bg-gray-50 border-b border-gray-100">
                    <tr>
                      ...
                      <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Joining Date</th>
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {currentEmployees.length > 0 ? (
                      currentEmployees.map((emp) => {
                        ...
                        // "Login Pending if not login yet on the platform"
                        ...
                        return (
                          ...
                          className="hover:bg-gray-50 transition-colors cursor-pointer">
                            ...
                            <td className="px-6 py-4 text-gray-600">{emp.dateOfJoining || '-'}</td>
                            <td className="px-6 py-4">
