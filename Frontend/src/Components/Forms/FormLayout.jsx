...
const FormLayout = ({
  ...
  return (
    <div className="relative w-full min-h-full">
      {/* Sticky Actions Navbar */}
      {actions && (
        <div className="sticky top-0 z-50 max-w-4xl mx-auto backdrop-blur-md px-4 py-3 sm:px-6 mb-4 mt-4 print:hidden">
      ...
      >
        ...
        >
          ...
          {showPhoto &&
            (photoUrl ? (
              <div
                className="w-20 sm:w-24 h-28 sm:h-32 
                            bg-gray-100 border 
                ...
                >
                  <div className="text-center">
                    {signatureUrl ? (
                      ...
                      <div
                        className="w-36 sm:w-48 h-14 sm:h-16 
